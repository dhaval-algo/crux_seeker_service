...
const regionToCurrency = {
    ...
    module.exports = {
        getIpDetails: async(ip) => {
            ...
            try {
                let details = await models.sequelize.query(`select latitude, longitude, accuracy_radius, continent_name, country_name,country_iso_code, subdivision_1_name, city_name
